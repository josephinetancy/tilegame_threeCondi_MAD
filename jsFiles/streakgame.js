...
1 = IndCircle + IntSquareLow CHECKED v2
    ...
    var compAns1,
        ...
        `<div class='parent'>
          ...
          <p> To help us, you'll play two games. </p>
                ...
                You'll keep all the bonus money you earn on top of the $2.75 you earn for your participation. </p>
...
*/
    ...
    let preambleText = `
           <div class='${attnChkDiv}' style="margin-top: 80px;">
            ${updatedPages}
            </div>` 
